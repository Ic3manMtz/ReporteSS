...
\begin{document}
	...
	\begin{center}
		\rule{\textwidth}{0.5pt}
		\\[0.7em]
		{\LARGE\bfseries Construcción de una base de datos de videos aéreos y su análisis vía herramientas de IA}\\[1cm]
	...
	\include{Secciones/marcoteorico.tex}
		
	\chapter{Objetivos y metodología}
	\include{Secciones/objetivos.tex}
	
	\chapter{Desarrollo}
	\include{Secciones/desarrollo.tex}
